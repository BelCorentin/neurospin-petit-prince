...
bids_root: Optional[PathLike] = '~/workspace_LPP/data/MEG/LPP/LPP_bids'
"""
...
deriv_root: Optional[PathLike] = '~/workspace_LPP/data/MEG/LPP/derivatives/final_all'
"""
...
data_type: Optional[Literal['meg', 'eeg']] = 'meg'
"""
The BIDS data type.
...
mf_cal_fname: Optional[str] = '~/workspace_LPP/data/MEG/LPP/MEG_cal_files/sss_cal_nsp_2017.dat'
"""
warning:
...
mf_ctc_fname: Optional[str] = '~/workspace_LPP/data/MEG/LPP/MEG_cal_files/ct_sparse_nsp_2017.fif'
"""
...
resample_sfreq: Optional[float] = 50
"""
...
conditions: Optional[Union[Iterable[str], Dict[str, str]]] = ['word']
"""
...
# Reference doc: https://mne.tools/mne-bids-pipeline/settings/general.html#config.bids_root


# to run this preprocessing: python run.py --config=./custom_config.py --steps=preprocessing

# '''


# study_name = 'LPP'
# bids_root = '~/workspace_LPP/data/MEG/LPP/LPP_bids'
# deriv_root = '~/workspace_LPP/data/MEG/LPP/derivatives/base2'
...
# # mf_head_origin: Union[Literal[auto], ArrayLike] = 'auto'
# # # Use the run 4: in the middle of the experiment, which gives us 
# # # the theoritically most stable head position
# # mf_reference_run: Optional[str] = '04'
# # mf_cal_fname: Optional[str] = None
# mf_cal_fname = '~/workspace_LPP/data/MEG/LPP/MEG_cal_files/sss_cal_nsp_2017.dat'
# # mf_ctc_fname: Optional[str] = None
# mf_ctc_fname = '~/workspace_LPP/data/MEG/LPP/MEG_cal_files/ct_sparse_nsp_2017.fif'
# ## Filtering
...
# event_repeated: Literal[error, drop, merge] = 'error'
# conditions: Optional[
#     Union[Iterable[str], Dict[str, str]]
# ] = None
# epochs_tmin: float = -0.2
# epochs_tmax: float = 0.5
# baseline: Optional[
...
# min_ecg_epochs: int = 5
# min_eog_epochs: int = 5
# n_proj_eog: Dict[str, float] = dict(
#     n_mag=1, n_grad=1, n_eeg=1
# )
# n_proj_ecg: Dict[str, float] = dict(
#     n_mag=1, n_grad=1, n_eeg=1
# )
# ssp_meg: Literal[separate, combined, auto] = 'auto'
# ecg_proj_from_average: bool = True
...
# runs = [f'0{i}' for i in range(10)]
# l_freq = 0.3
# h_freq = 100
# decim = 4
# subjects = ['sub-181017','sub-190611','sub-190717',
# 'sub-180131' ,'sub-190506','sub-190621','sub-220707',
# 'sub-180517','sub-190513','sub-190715']
# ch_types = ['meg']
