...
BIDS_PATH = BASE_PATH / 'BIDS_final'
RAW_DATA_PATH = BASE_PATH / 'raw_old'
PROC_DATA_PATH = BASE_PATH / 'derivatives' / 'final_all'
TASK = 'listen'

# We need to transform our NIP into an anynonimized number, refering to:
# https://cbel.atlassian.net/wiki/spaces/NEUROSPIN/pages/edit-v2/12648452
